  ...
  return (
    <span>
      ...
      {currentIndex < text.length && (
        <span
          className={`inline-block w-0.5 h-8 bg-violet-500 ml-1 ${
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <motion.div
            ...
            className="space-y-8"
            style={{
              transform: `translate(${calculateParallax(100).x}px, ${
                calculateParallax(100).y
              }px)`,
            }}
          >
            <motion.div variants={itemVariants} className="space-y-3">
              {isLoggedIn ? (
                ...
                <h1 className="  text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                  MAXIMIZE <br />
                  POTENTIAL WITH <br />
                  <span className="orbitron font-bold bg-clip-text text-transparent bg-gradient-to-r from-violet-600 to-purple-400">
                    AI-POWERED <br />
                    FITNESS
                  </span>{" "}
                  <br />
            ...
            <motion.p
              ...
              className=" saira text-lg text-muted-foreground max-w-lg"
            >
              {isLoggedIn ? (
                <>
                  Keep pushing your limits with our data-driven AI analysis
            ...
            {!isLoggedIn && (
              <motion.div variants={itemVariants}>
                <Button
                  ...
                  className="saira bg-gradient-to-r from-violet-700 via-violet-600 to-purple-500 text-white px-8 py-6 text-lg rounded-full hover:shadow-lg hover:shadow-violet-400/20 transition-all duration-300 hover:-translate-y-1"
                >
                  START YOUR JOURNEY
                </Button>
              </motion.div>
          ...
          <motion.div
            ...
            className="relative"
            style={{
              transform: `translate(${calculateParallax(50).x}px, ${
                calculateParallax(50).y
              }px)`,
            }}
          >
            <div
